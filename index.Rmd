...
title_length_data <- titledata %>%
  ...
  drop_na() %>% 
  mutate(as.numeric(as.character(fb_engagement))) %>% 
...
Nice. Let's get a better representation of this data, shall we? 

```{r}
ggplot(title_length_data, mapping = aes(x = title_length, y = total, color = as.numeric(fb_engagement)))+
  geom_point()+
